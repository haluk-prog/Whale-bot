...
# ---------------------------------------------------------------------------
GAINERS_MIN_PCT = 0.0            # Sadece pozitif (yükselen) coinler alınır
GAINERS_LIMIT = 20               # En çok yükselenden başlayarak ilk kaç coin izlenecek
GAINERS_REFRESH_SECONDS = 900    # Liste ne sıklıkla yenilenecek (15 dakika)
DAILY_CHECK_INTERVAL_SECONDS = 3600  # Günlük MA50 kontrolü ne sıklıkla yapılacak
